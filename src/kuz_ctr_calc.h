#ifndef _KUZ_CTR_CALC_H
#define _KUZ_CTR_CALC_H
...
// Nonlinear transformation vector
...
// Nonlinear reverse-transformation vector
...
static block round_Cs[32]; // Ci consts from GOST
static block round_keys[10];
...
void CTR_encrypt(uint8_t *ctr, const uint8_t *text, uint8_t *out_text, const uint8_t *key, uint64_t size);
